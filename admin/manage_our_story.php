...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE  FROM our_story WHERE id=?";
...
<head>
    ...
    <title>Manage Our Story Table</title>
        ...
        <table border="1">
            ...
            <?php foreach ($records as $record): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_our_story.php?id=<?php echo $record['id']; ?>" class="edit-btn">Edit</a>
