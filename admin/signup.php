...
if (isset($_POST['signup'])) {
    ...
    if (!$result) {
        ...
        $sql = "INSERT INTO tbladmin (UserName, Password, Email, token) VALUES (:username, :password, :email, :token)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':username', $username, PDO::PARAM_STR);
        ...
        echo "<script>alert('Registration successful. You can now login.'); document.location = 'index.php';</script>";
    } else {
