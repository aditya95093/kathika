...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $sql = "SELECT * FROM experiences_activities WHERE id=?";
...
if(isset($_POST['update'])){
    ...
    if(isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK){
        ...
        if(move_uploaded_file($imageTmpName, $newFilePath)){
            ...
            $sql = "UPDATE experiences_activities SET heading=?, image=?, description=? WHERE id=?";
            $stmt = $dbh->prepare($sql);
        ...
        $sql = "UPDATE experiences_activities SET heading=?, description=? WHERE id=?";
        $stmt = $dbh->prepare($sql);
...
<head>
    ...
    <title>Edit Experiences & Activities</title>
...
<body>
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <a href="manage_experiences_activities.php" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</body>
</html>
