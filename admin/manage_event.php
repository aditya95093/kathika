...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE FROM event_card WHERE id=?";
...
$sql = "SELECT hc.id, hc.heading, hci.image 
        FROM event_card hc
        JOIN event_card_images hci ON hc.id = hci.content_id";
                ...
                <?php foreach ($records as $record): ?>
                    <tr>
                        ...
                        <td data-label="Action">
                            <a href="edit_event.php?id=<?php echo $record['id']; ?>" class="edit-btn">Edit</a>
