...
if (isset($_POST['add'])) {
    ...
    if (move_uploaded_file($imageTmpName, $newFilePath)) {
        $sql = "INSERT INTO experiences_activities (heading, image_path, description) VALUES(?,?,?)";
        $stmt = $dbh->prepare($sql);
        $stmt->execute([$heading, $newFilePath, $description]);
        $message = "New Record created successfully";
        header('location: manage_experiences_activities.php');
        exit();
    } else {
...
<head>
    ...
    <title>Experiences & Activities</title>
    <style>
        * {
