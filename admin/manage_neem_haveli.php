...
if(isset($_POST['delete'])){
    $id = $_POST['delete'];
    $sql = "DELETE FROM neem_haveli where id=?";
...
<head>
    ...
    <title>Manage Neem Haveli</title>
        ...
        <table border="1">
            ...
            <?php foreach ($records as $record): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_neem_haveli.php?id=<?php echo $record['id']; ?>" class="edit-btn">Edit</a>
