...
if (isset($_POST['edit'])) {
    ...
    $sql = "UPDATE culture_and_heritage SET heading=?, image=?, description=? WHERE id=?";
    $stmt = $dbh->prepare($sql);
    $stmt->execute([$heading, $imageurl, $description, $id]);

    $message = "Record updated successfully";
    header('location:manage_culture_and_heritage.php');
    exit();
}
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM culture_and_heritage WHERE id=?";
    $stmt = $dbh->prepare($sql);
    $stmt->execute([$id]);
...
<head>
    ...
    <title>Edit Culture & Heritage</title>
