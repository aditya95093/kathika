...
if (isset($_POST['add'])) {
    ...
    if (move_uploaded_file($imageTmpName, $newFilePath)) {
        $sql = "INSERT INTO kathika_museum_haveli (heading, image, description) VALUES(?,?,?)";
        $stmt = $dbh->prepare($sql);
        $stmt->execute([$heading, $newFilePath, $description]);
        $message = "New Record created successfully";
        header('location: manage_kathika_museum_haveli.php');
        exit();
    } else {
...
<head>
    ...
    <title>Kathia Museum Haveli</title>
    <style>
        * {
