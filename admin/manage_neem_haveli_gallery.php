...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $sql = "DELETE  FROM neem_haveli_gallery WHERE id=?";
    $stmt = $dbh->prepare($sql);
    $stmt->execute([$id]);
    $message = "Record Delete successfully";
}

$sql = "SELECT * FROM neem_haveli_gallery";
$stmt = $dbh->query($sql);
...
<head>
    ...
    <title>Manage Neem Ki Haveli Gallery Table</title>
        ...
        <table border="1">
            ...
            <?php foreach ($records as $record): ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_neem_haveli_gallery.php?id=<?php echo $record['id']; ?>" class="edit-btn">Edit</a>
